...
const appReducer = (state: AppState = initialState, action: AppActions) => {
  switch (action.type) {
    case ActionTypes.SET_BOOKS:
      return {
        ...state,
        books: { ...state.books, data: action.payload, isLoading: false },
      };
    ...
    case ActionTypes.SET_PERSONS:
      return {
        ...state,
        persons: { ...state.persons, data: action.payload, isLoading: false },
      };
    ...
    case ActionTypes.SET_QUIZZES:
      return {
        ...state,
        quizzes: { ...state.quizzes, data: action.payload, isLoading: false },
      };
    ...
    case ActionTypes.SET_ARTICLES:
      return {
        ...state,
        articles: { ...state.articles, data: action.payload, isLoading: false },
      };
